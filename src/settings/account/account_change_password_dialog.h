...
/// Modal overlay dialog for changing the account password.
class AccountChangePasswordDialog final : public QWidget {
    Q_OBJECT

public:
    enum DialogCode { Rejected = 0, Accepted = 1 };

    explicit AccountChangePasswordDialog(QWidget *parent = nullptr);
...
private:
    ...
    QLineEdit *_currentPasswordField = nullptr;
    QLineEdit *_newPasswordField = nullptr;
    QLineEdit *_confirmField = nullptr;
